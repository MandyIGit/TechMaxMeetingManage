...
{
    /// <summary>
    /// tech_html_templateHandler 的摘要说明
    /// </summary>
    public class tech_html_templateHandler : PageBaseHandler
    {
        HttpRequest requst;
        ...
        private void Del()
        {
            ...
            {
                info.T_id = int.Parse(requst.QueryString["id"].ToString());
            }

            int result = tech_html_templateManager.Instance.Operation(info, "del");
            if (result > 0)
            {
        ...
        private void Edit()
        {
            ...
            info.T_id = int.Parse(requst.Form["t_id"].ToString());
            ...
            int result = tech_html_templateManager.Instance.Operation(info, "edit");
            if (result > 0)
            {
        ...
        private void Add()
        {
            ...
            int result = tech_html_templateManager.Instance.Operation(info, "add");
            if (result > 0)
            {
                response.Write("{result:'succ'}");
                return;
