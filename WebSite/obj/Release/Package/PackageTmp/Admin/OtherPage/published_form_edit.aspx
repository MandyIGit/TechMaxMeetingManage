<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="published_form_edit.aspx.cs" Inherits="WebSite.Admin.OtherPage.published_form_edit" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
        $(document).ready(function () {
            $("#btnSave").click(function () {

                var p_id = $("#ctl00_PanelBody_hid_p_id").val();
                var mid = $(".ddl_mid").val();
                ...
                $.ajax({
                    type: "post",
                    url: "/AjaxResponse/tech_published_formHandler.ashx?type=edit",
                    data: {
                        p_id: p_id,
                        mid: mid,
                        p_name: p_name,
...
<asp:Content ID="Content5" ContentPlaceHolderID="PanelBody" runat="server">
    ...
    <asp:HiddenField ID="hid_p_id" runat="server" />
