<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="meeting_reg_type_add.aspx.cs" Inherits="WebSite.Admin.OtherPage.meeting_reg_type_add" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $("#btnSave").click(function () {
                ...
                $.ajax({
                    type: "post",
                    url: "/AjaxResponse/tech_meeting_reg_typeHandler.ashx?type=add",
                    data: {
                        mid: mid,
                        ch_name: ch_name,
                        en_name: en_name,
