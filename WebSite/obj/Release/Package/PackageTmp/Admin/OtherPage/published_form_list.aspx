<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="published_form_list.aspx.cs" Inherits="WebSite.Admin.OtherPage.published_form_list" %>
            ...
            $('.mydel').click(function () {
                ...
                if (confirm('您确认要删除吗？')) {
                    $.ajax({
                        ...
                        type: 'GET',
                        url: '/AjaxResponse/tech_published_formHandler.ashx?type=del&id=' + deviceid,
            ...
            <asp:Repeater ID="rpt_list" runat="server">                
                <ItemTemplate>
                    <tr>
                        ...
                        <td>
                            <a href="published_form_edit.aspx?id=<%#Eval("p_id") %>" class="btn btn-secondary btn-xs">编辑</a>
                            <a deviceid='<%#Eval("p_id") %>' class="btn btn-red btn-xs mydel" href="#">删除</a>
                        </td>
                    </tr>
                </ItemTemplate>
            </asp:Repeater>
