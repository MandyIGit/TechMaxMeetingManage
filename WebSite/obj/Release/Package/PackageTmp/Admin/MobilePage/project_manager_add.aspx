<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="project_manager_add.aspx.cs" Inherits="WebSite.Admin.MobilePage.project_manager_add" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $('#btnSave').click(function () {
                ...
                $.ajax({
                    type: "post",
                    url: "/AjaxResponse/tech_project_managerHandler.ashx?type=add",
...
<asp:Content ID="Content5" ContentPlaceHolderID="PanelBody" runat="server">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <input id="full_name" name="full_name" type="text" class="form-control" style="width:300px;" />
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <input id="mobile" name="mobile" type="text" class="form-control" style="width:300px;" />
        </div>
    </div>
    <div class="form-group-separator">
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <input id="login_name" name="login_name" type="text" class="form-control" style="width:300px;" />
        </div>
    </div>
    <div class="form-group-separator">
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <input id="login_pwd" name="login_pwd" type="text" class="form-control" style="width:300px;" />
        </div>
    </div>
    <div class="form-group-separator">
    </div>
