<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="mtemplate_type_add.aspx.cs" Inherits="WebSite.Admin.MobilePage.mtemplate_type_add" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $('#btnSave').click(function () {
                ...
                $.ajax({
                    type: "post",
                    url: "/AjaxResponse/tech_mobile_typeHandler.ashx?type=add",
...
<asp:Content ID="Content5" ContentPlaceHolderID="PanelBody" runat="server">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <input id="mtype_name" name="mtype_name" type="text" class="form-control" style="width:300px;" />
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <textarea id="mtype_memo" name="mtype_memo" class="form-control" style="width:300px; height:80px;"></textarea>
        </div>
    </div>
    <div class="form-group-separator">
    </div>
