<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="mtemplate_version_list.aspx.cs" Inherits="WebSite.Admin.MobilePage.mtemplate_version_list" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function LoadTable() {
            ...
            $.ajax({
                type: "post",
                url: "/AjaxResponse/tech_mobile_versionHandler.ashx?type=1&postvalue=<msg_data><pageIndex>" + pageindex + "</pageIndex><pageSize>10</pageSize></msg_data>",
        ...
        function mydelete(deviceid) {
            ...
            if (confirm('您确认要删除吗？')) {
                $.ajax({
                    ...
                    type: 'GET',
                    url: '/AjaxResponse/tech_mobile_versionHandler.ashx?type=del&id=' + deviceid,
                    success: function (data) {
                        var r = eval("(" + data + ")");
                        if (r.result == 'succ') {
                            alert(r.msg);
        ...
        function open_mtemplate_version_add() {
            window.open('mtemplate_version_add.aspx', 'newwindow', 'width=860, height=560, top=90, left=220, toolbar=no, menubar=no, scrollbars=yes, resizable=no, location=no, status=no')
        }
...
<asp:Content ID="Content3" ContentPlaceHolderID="PanelTitleDesc" runat="server">
    Mobile Template Version List
</asp:Content>
<asp:Content ID="Content4" ContentPlaceHolderID="PanelHeader" runat="server">
    <input id="btn_save" type="button" value="添加" class="btn btn-blue" onclick="open_mtemplate_version_add()" />
</asp:Content>
