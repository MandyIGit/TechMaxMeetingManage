<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="mt_open_css.aspx.cs" Inherits="WebSite.Admin.MobilePage.mt_open_css" %>
            ...
            $('#file_upload').uploadifive({
                ...
                'onUploadComplete': function (file, data) {
                    if (data.indexOf("仅支持") == -1) {
                        $("#mtemplate_css").attr("value", $("#ftp_upload_url").val() + data);
                        $("#queue").hide();
                        UpdateCss();
                    }
                    else {
...
<body>
    <form id="MyForm">
        <div style="margin:auto;">
            ...
            <table>
                <tr>
                    <td><input id="mtemplate_css" name="mtemplate_css" type="text" value="<%=mtemplate_css %>" style="width:500px; height:28px; line-height:28px; padding:0;color:#111;font-size:14px;" readonly="readonly" /></td>
                    <td><input id="file_upload" name="file_upload" type="file" style="width: 28px;height:28px;line-height:28px;color:#111;font-size:14px;" /></td>
                </tr>
            </table>
            <div id="queue"></div>
        </div>
