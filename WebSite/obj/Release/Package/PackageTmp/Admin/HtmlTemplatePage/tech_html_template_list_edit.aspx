<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="tech_html_template_list_edit.aspx.cs" Inherits="WebSite.Admin.HtmlTemplatePage.tech_html_template_list_edit" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $("#btnSave").click(function () {
                ...
                $.ajax({
                    type: "post",
                    url: "/AjaxResponse/tech_html_template_listHandler.ashx?type=edit",
                    data: {
                        mid: mid,
                        tm_id: tm_id,
                        tm_name: tm_name,
                    ...
                    success: function (data) {
                        var r = eval("(" + data + ")");
                        if (r.result == 'succ') {
                            window.location.href = 'tech_html_template_list_list.aspx?page=<%=page%>';
                        } else {
                            alert(r.msg);
                        }
                    },
