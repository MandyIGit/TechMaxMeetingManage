<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="WordEdit.aspx.cs" Inherits="WebSite.Admin.ForbiddenWord.WordEdit" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $("#btnSave").click(function () {
                ...
                $.ajax({
                    type: "post",
                    url: "/AjaxResponse/tech_forbidden_wordHandler.ashx?type=edit",
                    data: {
                        id: $("#txt_id").val(),
                        word: word
                    },
                    ...
                    success: function (data) {
                        var r = eval("(" + data + ")");
                        if (r.result == 'succ') {
                            window.location.href = 'WordList.aspx?page=<%=page%>';
                        } else {
                            alert(r.msg);
                        }
                    },
