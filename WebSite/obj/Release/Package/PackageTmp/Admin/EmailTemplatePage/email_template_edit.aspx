<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="email_template_edit.aspx.cs" Inherits="WebSite.Admin.EmailTemplatePage.email_template_edit" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $("#btnSave").click(function () {
                ...
                $.ajax({
                    type: "post",
                    url: "/AjaxResponse/email_templateHandler.ashx?type=edit",
                    data: {
                        id: id,
                        mid: mid,
                        tp_name: tp_name,
