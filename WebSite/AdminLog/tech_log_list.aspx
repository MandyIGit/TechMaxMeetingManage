<%@ Page Title="" Language="C#" MasterPageFile="~/AdminLog/AdminLog.Master" AutoEventWireup="true" CodeBehind="tech_log_list.aspx.cs" Inherits="WebSite.AdminLog.tech_log_list" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function LoadTable() {
            ...
            $.ajax({
                type: "post",
                url: "/AjaxResponse/tech_operating_recordHandler.ashx?type=1&postvalue=<msg_data><pageIndex>" + pageindex + "</pageIndex><pageSize>10</pageSize></msg_data>",
