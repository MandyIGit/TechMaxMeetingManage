<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="tech_meeting_type_add.aspx.cs" Inherits="WebSite.Admin.MeetingPage.tech_meeting_type_add" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $('#btnSave').click(function () {
                ...
                $.ajax({
                    type: "post",
                    url: "/AjaxResponse/tech_meeting_typeHandler.ashx?type=add",
                    data: {
                    ...
                    success: function (data) {
                        var r = eval("(" + data + ")");
                        if (r.result == 'succ') {
                            window.location.href = 'tech_meeting_type_list.aspx';
                        } else {
                            alert(r.msg);
                        }
                    },
