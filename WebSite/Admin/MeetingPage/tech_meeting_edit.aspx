<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="tech_meeting_edit.aspx.cs" Inherits="WebSite.Admin.MeetingPage.tech_meeting_edit" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $("#btnSave").click(function () {
                ...
                var is_weizhankaitong = $(".ddl_is_weizhankaitong").val();                
                ...
                $.ajax({
                    type: "post",
                    url: "/AjaxResponse/tech_meetingHandler.ashx?type=edit",
                    data: {
                        mtype_id: mtype_id,
                        mid: mid,
                        mname: mname,
                        ...
                        is_weizhankaitong: is_weizhankaitong
                    },
                    beforeSend: function (XMLHttpRequest, textStatus) { },
                    success: function (data) {
                        var r = eval("(" + data + ")");
                        if (r.result == 'succ') {
                            window.location.href = 'tech_meeting_list.aspx?page=<%=page%>';
                        } else {
                            alert(r.msg);
                        }
                    },
...
<asp:Content ID="Content5" ContentPlaceHolderID="PanelBody" runat="server">
    ...
    <div class="form-group">
        <label class="col-sm-2 control-label" for="txt_mtype_id">会议编码</label>
        <div class="col-sm-10">
    ...
    <div class="form-group">
        <label class="col-sm-2 control-label">主形象路径</label>
        <div class="col-sm-10">
            <asp:TextBox ID="txt_m_img" runat="server" Width="300px" CssClass="form-control txt_m_img">http://</asp:TextBox>
        </div>
    </div>
    <div class="form-group-separator">
    </div>
    ...
    <div class="form-group">
        <label class="col-sm-2 control-label">是否开通自助建站</label>
        <div class="col-sm-10">
            <asp:DropDownList ID="ddl_is_weizhankaitong" runat="server" Width="300px" CssClass="form-control ddl_is_weizhankaitong">
                <asp:ListItem Value="1">是</asp:ListItem>
                <asp:ListItem Value="2">否</asp:ListItem>
            </asp:DropDownList>
        </div>
