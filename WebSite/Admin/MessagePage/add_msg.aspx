<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="add_msg.aspx.cs" Inherits="WebSite.Admin.MessagePage.add_msg" %>
        ...
        $(document).ready(function () {
            ...
            $("#btnSave").click(function () {
                if (CheckEmpty()) {
                    $.ajax({
                        type: "post",
                        url: "/AjaxResponse/tech_messageHandler.ashx?type=addMsg",
                        ...
                        success: function (data) {
                            ...
                            if (r.result == 'succ') {
                                alert("信息保存成功！");
                                window.location.href = "msg_list.aspx";
                            }
                            else {
                                alert(r.msg);
                            }
...
<asp:Content ID="Content5" ContentPlaceHolderID="PanelBody" runat="server">
    ...
    <div class="form-group">
        <label class="col-sm-2 control-label" for="Status">处理状态</label>
        <div class="col-sm-10">
    ...
    <div class="form-group">
        <label class="col-sm-2 control-label">会议需求</label>
        <div class="col-sm-10">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <input type="text" id="MeetingScale" name="MeetingScale" class="form-control" />
        </div>
    </div>
    <div class="form-group-separator">
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <input type="text" id="MeetingStartTime" name="MeetingStartTime" class="form-control datepicker" data-format="yyyy-mm-dd" />
        </div>
    </div>
    <div class="form-group-separator">
    </div>
    ...
    <div class="form-group">
        <label class="col-sm-2 control-label" for="isComm">是否沟通</label>
        <div class="col-sm-10">
    ...
    <div class="form-group">
        <label class="col-sm-2 control-label" for="CommProgress">沟通进度</label>
        <div class="col-sm-10">
            <input type="text" id="CommProgress" name="CommProgress" class="form-control" />
        </div>
    </div>
    <div class="form-group-separator">
    </div>
