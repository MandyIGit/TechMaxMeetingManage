<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="article_type_add.aspx.cs" Inherits="WebSite.Admin.OtherPage.article_type_add" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $("#btnSave").click(function () {
                ...
                $.ajax({
                    type: "post",
                    url: "/AjaxResponse/tech_article_typeHandler.ashx?type=add",
                    data: {
                        mid: mid,
                        type_name: type_name,
                        app_type: app_type
