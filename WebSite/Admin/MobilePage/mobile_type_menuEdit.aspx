<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="mobile_type_menuEdit.aspx.cs" Inherits="WebSite.Admin.MobilePage.mobile_type_menuEdit" %>
...
<head>
    ...
    <script type="text/javascript">
        ...
        function getContent() {
            $.ajax({
                type: "post",
                url: "/AjaxResponse/tech_mobile_type_menuHandler.ashx?type=GetMenu",
        ...
        function dosave() {
            ...
            $.ajax({
                type: "post",
                url: "/AjaxResponse/tech_mobile_type_menuHandler.ashx?type=ModiMenu",
        ...
        function addtop() {
            $.ajax({
                type: "post",
                url: "/AjaxResponse/tech_mobile_type_menuHandler.ashx?type=AddTopMenu",
                data: $("#myform").serializeArray(),
                success: function (data) {
        ...
        function deletemenu(i) {
            art.dialog.confirm("<font size='2px'>您确定要删除吗？</font>", function () {
                $.ajax({
                    type: "post",
                    url: "/AjaxResponse/tech_mobile_type_menuHandler.ashx?type=DeleteMenu&menu_id=" + i,
                    data: $("#myform").serialize(),
                    success: function (data) {
                        getContent();
                    },
...
<body>
    <form id="myform">
        <input type="hidden" id="mtype_id" name="mtype_id" value="0" />
