<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="tech_html_template_add.aspx.cs" Inherits="WebSite.Admin.HtmlTemplatePage.tech_html_template_add" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $("#btnSave").click(function () {
                ...
                $.ajax({
                    type: "post",
                    url: "/AjaxResponse/tech_html_templateHandler.ashx?type=add",
                    data: {
                        mid: mid,
                        tm_id: tm_id,
                        tm_name: tm_name,
                    ...
                    success: function (data) {
                        var r = eval("(" + data + ")");
                        if (r.result == 'succ') {
                            window.location.href = 'tech_html_template_list.aspx';
                        } else {
                            alert(r.msg);
                        }
                    },
...
<asp:Content ID="Content5" ContentPlaceHolderID="PanelBody" runat="server">
    ...
    <div class="form-group">
        <label class="col-sm-2 control-label" for="ddl_tm_id">选择样式模板</label>
        <div class="col-sm-10">
