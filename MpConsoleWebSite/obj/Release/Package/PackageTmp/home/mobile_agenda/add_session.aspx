<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="add_session.aspx.cs" Inherits="MpConsoleWebSite.home.mobile_agenda.add_session" %>
...
<head>
    ...
    <script language="javascript" type="text/javascript"> 
        ...
        function addRole(type) {
            OpenUrl('/home/mobile_agenda/add_roles.aspx?type=' + type, '添加角色', 650, 250);
        }

        function showting(ting) {
            GetHallList();
        }
        ...
        function addSession() {
            if (panduan()) {
                ...
                $.ajax({
                    type: "post",
                    url: "/AjaxResponse/mobile_agendaHandler.ashx?type=AddSession",
                    data: $("#Myform").serialize(),
        ...
        <div class="p10">
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="infotablel">
                ...
                <tr>
                    <th>时间区间</th>
                    <td>
                        <input name="session_btime" id="session_btime" type="text" class="txt txt60" value="08:00" maxlength="5"
                            onclick="WdatePicker({ skin: 'blue', readOnly: false, dateFmt: 'HH:mm' })" />
                        -
                        <input name="session_etime" id="session_etime" type="text" class="txt txt60" value="18:00" maxlength="5"
                            onclick="WdatePicker({ skin: 'blue', readOnly: false, dateFmt: 'HH:mm' })" /></td>
                </tr>
                <tr>
                    <th>
                        <a href="javascript:OpenUrl('/home/mobile_agenda/modifyhall.aspx?hid=0','增加会议厅会场',450,200);"
                            class="u">会议厅场</a></th>
                    <td>
                ...
                <!--<tr>
                <th>角色人员</th>
                <td><select id="usercode" name="usercode" class="s300"><option value="0">请选择人员</option></select></td>
                </tr>
                <tr>
                    <th>角色</th>
                    <td><select id="juese" name="juese" class="s300"><option value="0">请选择</option>
                    <option value="1">主持人</option>
                    <option value="2">点评专家</option>
                    <option value="3">讲者</option>
