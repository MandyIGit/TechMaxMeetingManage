<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="add_sch.aspx.cs" Inherits="MpConsoleWebSite.home.mobile_agenda.add_sch" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function addSession() {
            ...
            $.ajax({
                type: "post",
                url: "/AjaxResponse/mobile_agendaHandler.ashx?type=AddSchedule",
                data: $("#Myform").serialize(),
                beforeSend: function (XMLHttpRequest) { },
                success: function (data) {
                    var r = eval("(" + data + ")");
