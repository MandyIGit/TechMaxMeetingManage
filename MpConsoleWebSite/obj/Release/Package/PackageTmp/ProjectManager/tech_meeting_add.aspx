<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="tech_meeting_add.aspx.cs" Inherits="MpConsoleWebSite.ProjectManager.tech_meeting_add" %>
        ...
        <div class="Content">
            <div class="listtable" id="system_data">
                <table width="100%" border="0" cellspacing="0" cellpadding="0" class="infotablel">
                    ...
                    <tr>
                        <th scope="row">选择会议类型</th>
                        <td>
                            <select id="mtype_id" name="mtype_id" style="width:310px;">
                                <%=tmt_option %>
                            </select>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <input class="txt" id="mid" name="mid" type="text" style="width:150px;" readonly="readonly" value="<%=mid %>" />
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <input class="txt Wdate" id="begindate" name="begindate" type="text" onclick="WdatePicker({skin:'blue',readOnly:true})" readonly="true" style="width:150px;" />
                        </td>
                    </tr>
                    <tr>
