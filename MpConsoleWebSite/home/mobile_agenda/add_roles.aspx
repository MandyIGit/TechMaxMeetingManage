<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="add_roles.aspx.cs" Inherits="MpConsoleWebSite.home.mobile_agenda.add_roles" %>
...
<head>
    ...
    <script type="text/javascript">
        ...
        function panduan() {
            ...
            if ($("#rolefamilyname").val().replace(/(^\s*)|(\s*$)/g, "") == "") {
                alert("姓氏不能为空！");
                return false;
            } else if ($("#rolegivenname").val().replace(/(^\s*)|(\s*$)/g, "") == "") {
                alert("名字不能为空！");
                return false;
            }
            return true;
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="infotablel">
            <tr>
                ...
                <td>
                    ...
                    名字：<input name="rolegivenname" type="text" class="txt" id="rolegivenname" placeholder="名字" value="" style="width: 150px;" /><br />
