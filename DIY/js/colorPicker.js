var pick, colorElement, chooseColor, colorPoint, colorBar, rgbaText, colorBarThumb, transparency, transparencyBar, transparencyThumb, web_back_color;
...
var init = function () {
    ...
    web_back_color = document.getElementById('web_back_color');
...
var changeTransparency = function (x) {
    ...
    web_back_color.value = changeTransparencyColor;
