<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="tech_meeting_edit.aspx.cs" Inherits="DIY.ProjectManager.tech_meeting_edit" %>
            ...
            <div class="listtable" id="system_data">
                <table width="100%" border="0" cellspacing="0" cellpadding="0" class="infotablel">
                    ...
                    <tr>
                        ...
                        <td>
                            <input class="txt" id="m_website" name="m_website" type="text" style="width:300px;" value="<%=tm.m_website %>" <%if (tm.is_weizhankaitong == 1) { Response.Write("readonly=\"readonly\" disabled=\"disabled\""); } %> />
                            （微站开通后，网址不可修改）
                        </td>
                    </tr>
                    <tr>
