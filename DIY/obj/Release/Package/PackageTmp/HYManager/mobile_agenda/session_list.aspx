<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="session_list.aspx.cs" Inherits="DIY.HYManager.mobile_agenda.session_list" %>
    ...
    <form id="Myform">
        ...
        <div class="listtable">
            ...
            <div class="listmenu">
                ...
                <a class="btnwhite" onclick="OpenUrl('add_session.aspx','增加会议单元',980,600)">增加会议单元</a>

                <div class="clear"></div>
                <script type="text/javascript">                 
                    function addhall() {
                        OpenUrl('modifyhall.aspx?hid=0', '增加会议厅会场', 450, 200);
                    }
                    function updatehall() {
                        OpenUrl('hall_list.aspx', '修改会议厅会场', 450, 300);
                    }
