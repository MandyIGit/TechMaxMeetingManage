<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="speaker_list.aspx.cs" Inherits="DIY.HYManager.mobile_agenda.speaker_list" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function speaker_edit(user_code) {
            OpenWindowUrl_Two("speaker_edit.aspx?user_code=" + user_code, "编辑简介", 700, 500);
        }
