<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="add_sch.aspx.cs" Inherits="DIY.HYManager.mobile_agenda.add_sch" %>
        ...
        function getSession() {
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $("#btime").val(r.session_btime);
                    $("#etime").val(r.session_etime);
