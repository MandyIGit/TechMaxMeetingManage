...
namespace DIY.AjaxResponse
{
    ...
    public class PageBaseHandler : IHttpHandler
    {
        ...
        {
            string mid = WebCommon.GetCookie(WebCommon.MEETING_KEY, 0).Split('=')[1];
            string mtype_id = WebCommon.GetCookie(WebCommon.MEETING_KEY, 1).Split('=')[1];
            tech_operating_record operating_record = new tech_operating_record();
            operating_record.Admin_code = 0;
            operating_record.Operating_user = mid;
            ...
            tech_operating_recordManager.Instance.Operating(operating_record, "add_msg_diy");
        }
